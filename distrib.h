...
static std::uniform_int_distribution<> unif_T(0, T - 1);
static std::uniform_int_distribution<> unif_N(0, N - 1);
static std::uniform_int_distribution<> unif2(0, 1);
static std::uniform_int_distribution<ZmodQ> unif(0, std::numeric_limits<ZmodQ>::max());
static std::uniform_int_distribution<> vi(0, 3);
...
int32_t Sample(const Distrib& Chi); /* sample integer with gaussian distribution */
